    ...
    categories = {
        {
            ...
            items = {
                ...
                },
                {
                    ...
                    id = "v031_car_racinghothatch_encounter_takedown"
                },
                {
                ...
                {
                    name = "Camión Truck With Car Trailer",
                    id = "v004_car_articulatedtruck_commercial_cartransport_trailer"
                },
                {
                    name = "Camión Truck With Flatbed Trailer",
                    id = "v004_car_articulatedtruck_commercial_lowloader_trailer"
                },
                {
                    name = "Camión Truck With Signaljammer Trailer",
                    id = "v004_car_articulatedtruck_commercial_radarjammer_trailer"
                },
                {
                    name = "Camión Truck With Random Trailer",
                    id = "v004_car_articulatedtruck_commercial_randomtrailer"
                },
                {
        ...
        },
        {
            ...
            items = {
                ...
                {
                    separator = true,
                    name = "Mission Vehicles (may crash)"
                },
                {
                    name = "Thunderbarge",
        ...
        },
        {
            ...
            items = {
                ...
                {
                    name = "PR17 Rocket Drone",
                    id = "v251_helicopter_rocketdrone_military"
                },
                {
                    name = "Suicide Drone",
                    id = "v252_helicopter_suicidedrone_military"
                },
                {
                    name = "Guard Drone",
                ...
                {
                    name = "Prospero Sky Crane With Container",
                    id = "v200_helicopter_heavylift_rebel_mission_special"
                },
                {
                    name = "Garland Kind Studios Chopper",
                    id = "v205_helicopter_utility_garland"
                },
                {
                    name = "Emvasion Float Heli",
                    id = "v206_helicopter_bubblescout_javi"
                },
                {
                    name = "PR83 Attack Drone",
                    id = "v250_helicopter_mediumattackdrone_tornado"
                },
                {
                    name = "Skycastle Cargo Jet",
                    id = "v401_plane_cargotransport_signal_jammer"
                },
                {
                    name = "Emvasion Airship",
                ...
                {
                    name = "PR17 Rocket Drone",
                    id = "v251_helicopter_rocketdrone_rebel"
                },
                {
                    name = "Suicide Drone",
                    id = "v252_helicopter_suicidedrone_rebel"
                },
                {
                    name = "Decoy Drone",
                    id = "v253_helicopter_decoydrone_rebel"
                },
                {
                    name = "Guard Drone",
        ...
        },
        {
            ...
            items = {
                ...
                {
                    name = "Frag Grenade",
                    id = "w301_frag_grenade"
                },
                {
                    name = "Concussion Grenade",
                    id = "w303_concussion_grenade"
                },
                {
                ...
                {
                    name = "Bullet Streamer Wingsuit",
                    id = "wpn_990_premium_wingsuit_bullet_streamer"
                },
                {
                ...
                {
                    name = "Substrate AA Gun",
                    id = "dlc2_substrate_weapon_aa_gun_01"
                },
                {
                    name = "Substrate AA Tank",
                    id = "dlc2_substrate_weapon_aa_tank_01"
                },
                {
                    name = "Substrate APC",
                    id = "dlc2_substrate_weapon_apc_01"
                },
                {
                    name = "Substrate Cannon Truck",
                    id = "dlc2_substrate_weapon_cannon_truck_01"
                },
                {
                    name = "Substrate Helicopter",
                    id = "dlc2_substrate_weapon_heli_light_01"
                },
                {
                    name = "Substrate Modern Tank",
                    id = "dlc2_substrate_weapon_modern_tank_01"
                },
                {
                    name = "Substrate Mortar",
                    id = "dlc2_substrate_weapon_mortar_01"
                },
                {
                    name = "Substrate AA Gun (Outro)",
                    id = "dlc2_substrate_weapon_aa_gun_01_outro"
                },
                {
                    name = "Substrate AA Tank (Outro)",
                    id = "dlc2_substrate_weapon_aa_tank_01_outro"
                },
                {
                    name = "Substrate APC (Outro)",
                    id = "dlc2_substrate_weapon_apc_01_outro"
                },
                {
                    name = "Substrate Cannon Truck (Outro)",
                    id = "dlc2_substrate_weapon_cannon_truck_01_outro"
                },
                {
                    name = "Substrate Modern Tank (Outro)",
                    id = "dlc2_substrate_weapon_modern_tank_01_outro"
                },
                {
        ...
        --         {
        --             name = "Train 1",
        --             id = "v502_train_armoredengine_military_01"
        --         },
        --     }
        -- },
        {
            name = "Skins",
            type = "skin",
            button_name = "Change Skin",
            items = {
                { separator = true, name = "Main Characters" },
                { name = "Rico", id = "rico" },
                { name = "Mira", id = "mira" },
                ...
                { name = "Javi", id = "javi" },
                { name = "Oscar", id = "oscar" },
                -- { name = "Oscar Young", id = "oscar_young" }, -- crashes
                { name = "Cesar", id = "cesar" },
                { name = "Lanza", id = "lanza" },
                -- { name = "Dictator", id = "dictator" }, -- crashes
                -- { name = "Dictator Guard", id = "dictator_guard" }, -- crashes
                { name = "Garland", id = "garland" },
                { name = "Izzy", id = "izzy" },
                { separator = true, name = "Combatants" },
                ...
                { name = "Private Enemy 1", id = "private_enemy_001" },
                { name = "Private Enemy 2", id = "private_enemy_002" },
                ...
                -- { name = "Female Rebel 1 Avg", id = "female_rebel_001_avg" },  -- crashes
                -- { name = "Female Rebel 2 Avg", id = "female_rebel_002_avg" },  -- crashes
                -- { name = "Female Rebel 3 Avg", id = "female_rebel_003_avg" },  -- crashes
                -- { name = "Female Rebel 4 Avg", id = "female_rebel_004_avg" },  -- crashes
                { name = "Female Rebel Prisoner 1", id = "female_rebel_prisoner_01" },
                { name = "Female Rebel Prisoner 2", id = "female_rebel_prisoner_02" },
                { name = "Female Rebel Prisoner 3", id = "female_rebel_prisoner_03" },
                { name = "Female Rebel Tier 1 1", id = "female_rebel_tier_1_01" },
                { name = "Female Rebel Tier 1 2", id = "female_rebel_tier_1_02" },
                { name = "Female Rebel Tier 1 3", id = "female_rebel_tier_1_03" },
                { name = "Female Rebel Tier 2 1", id = "female_rebel_tier_2_01" },
                { name = "Female Rebel Tier 2 2", id = "female_rebel_tier_2_02" },
                { name = "Female Rebel Tier 2 3", id = "female_rebel_tier_2_03" },
                { name = "Female Rebel Tier 3 1", id = "female_rebel_tier_3_01" },
                { name = "Female Rebel Tier 3 2", id = "female_rebel_tier_3_02" },
                { name = "Female Rebel Tier 3 3", id = "female_rebel_tier_3_03" },
                -- { name = "Male Rebel 1 Avg", id = "male_rebel_001_avg" },  -- crashes
                -- { name = "Male Rebel 2 Avg", id = "male_rebel_002_avg" },  -- crashes
                -- { name = "Male Rebel 3 Avg", id = "male_rebel_003_avg" },  -- crashes
                -- { name = "Male Rebel 4 Avg", id = "male_rebel_004_avg" },  -- crashes
                { name = "Male Rebel Prisoner 1", id = "male_rebel_prisoner_01" },
                { name = "Male Rebel Prisoner 2", id = "male_rebel_prisoner_02" },
                { name = "Male Rebel Prisoner 3", id = "male_rebel_prisoner_03" },
                { name = "Male Rebel Tier 1 1", id = "male_rebel_tier_1_01" },
                { name = "Male Rebel Tier 1 2", id = "male_rebel_tier_1_02" },
                { name = "Male Rebel Tier 1 3", id = "male_rebel_tier_1_03" },
                { name = "Male Rebel Tier 1 4", id = "male_rebel_tier_1_04" },
                { name = "Male Rebel Tier 2 1", id = "male_rebel_tier_2_01" },
                { name = "Male Rebel Tier 2 2", id = "male_rebel_tier_2_02" },
                { name = "Male Rebel Tier 2 3", id = "male_rebel_tier_2_03" },
                { name = "Male Rebel Tier 2 4", id = "male_rebel_tier_2_04" },
                { name = "Male Rebel Tier 3 1", id = "male_rebel_tier_3_01" },
                { name = "Male Rebel Tier 3 2", id = "male_rebel_tier_3_02" },
                { name = "Male Rebel Tier 3 3", id = "male_rebel_tier_3_03" },
                { name = "Male Rebel Tier 3 4", id = "male_rebel_tier_3_04" },
                { name = "Sargentos Rebel Female 1", id = "sargentos_rebel_female_01" },
                { name = "Sargentos Rebel Female 2", id = "sargentos_rebel_female_02" },
                { name = "Sargentos Rebel Female 3", id = "sargentos_rebel_female_03" },
                { name = "Sargentos Rebel Male 1", id = "sargentos_rebel_male_01" },
                { name = "Sargentos Rebel Male 2", id = "sargentos_rebel_male_02" },
                { name = "Sargentos Rebel Male 3", id = "sargentos_rebel_male_03" },
                -- { name = "Npc Mil Parachute", id = "npc_mil_parachute" }, -- crashes
                { separator = true, name = "Civilians" },
                -- { name = "Female Gen 1", id = "civ_female_gen_001" }, -- crashes
                -- { name = "Female Gen 2", id = "civ_female_gen_002" }, -- crashes
                -- { name = "Female Gen 3", id = "civ_female_gen_003" }, -- crashes
                -- { name = "Female Gen 4", id = "civ_female_gen_004" }, -- crashes
                -- { name = "Female Gen 5", id = "civ_female_gen_005" }, -- crashes
                -- { name = "Female Gen 6", id = "civ_female_gen_006" }, -- crashes
                -- { name = "Male Gen 1", id = "civ_male_gen_001" }, -- crashes
                -- { name = "Male Gen 2", id = "civ_male_gen_002" }, -- crashes
                -- { name = "Male Gen 3", id = "civ_male_gen_003" }, -- crashes
                -- { name = "Male Gen 4", id = "civ_male_gen_004" }, -- crashes
                -- { name = "Male Gen 5", id = "civ_male_gen_005" }, -- crashes
                -- { name = "Male Gen 6", id = "civ_male_gen_006" }, -- crashes
                -- { name = "Alpine Scientist 1", id = "civ_alpine_scientist_001" }, -- crashes
                -- { name = "Alpine Scientist 2", id = "civ_alpine_scientist_002" }, -- crashes
                { name = "Alpine Scientist Female", id = "civ_alpine_scientist_female" },
                { name = "Alpine Scientist Male", id = "civ_alpine_scientist_male" },
                { name = "Scientist Female", id = "civ_scientist_female" },
                { name = "Scientist Male", id = "civ_scientist_male" },
                { name = "Alpine Worker Female", id = "civ_alpine_worker_female_01" },
                { name = "Alpine Worker Male", id = "civ_alpine_worker_male_01" },
                { name = "Node Hacker Male 1", id = "civ_node_hacker_male_01" },
                { name = "Node Hacker Male 2", id = "civ_node_hacker_male_02" },
                { name = "Node Hacker Male 3", id = "civ_node_hacker_male_03" },
                { name = "Node Hacker Male 4", id = "civ_node_hacker_male_04" },
                { name = "Techengineer Female", id = "civ_techengineer_female" },
                { name = "Techengineer Male", id = "civ_techengineer_male" },
                { name = "Miner Male", id = "civ_miner_male" },
                { name = "Construction Worker Female", id = "civ_construction_worker_female_01" },
                { name = "Construction Worker Male", id = "civ_construction_worker_male_01" },
                { name = "Lumberyard Female", id = "civ_lumberyard_female_01" },
                { name = "Lumberyard Male", id = "civ_lumberyard_male_01" },
                { name = "Mechanic Female", id = "civ_mechanic_female_01" },
                { name = "Mechanic Male", id = "civ_mechanic_male_01" },
                -- { name = "Steelworker", id = "civ_steelworker_001" }, -- crashes
                { name = "Steelworker Female", id = "civ_steelworker_female_01" },
                { name = "Evil Target Female", id = "civ_evil_target_female_01" },
                { name = "Evil Target Male", id = "civ_evil_target_male_01" },
                { name = "Garland Crew Female", id = "civ_garland_crew_female_01" },
                { name = "Garland Crew Male", id = "civ_garland_crew_male_01" },
                { name = "Garland Location Scout", id = "civ_garland_location_scout_001" },
                { name = "Garland Pa", id = "civ_garland_pa_001" },
                { name = "Garland Pa Male", id = "civ_garland_pa_male_01" },
                { name = "Garland Stuntperson Helmet Female", id = "civ_garland_stuntperson_helmet_female_01" },
                { name = "Garland Stuntperson Helmet Male", id = "civ_garland_stuntperson_helmet_male_01" },
                { name = "Javi Soldier", id = "civ_javi_soldier_001" },
                { name = "Javi Soldier Full Body", id = "civ_javi_soldier_full_body" },
                { name = "Sargento Soldier Female", id = "civ_sargento_soldier_female_01" },
                { name = "Sargento Soldier Male", id = "civ_sargento_soldier_male_01" },
                { name = "Prisoner Female", id = "civ_prisoner_female" },
                { name = "Prisoner Male", id = "civ_prisoner_male" },
                { name = "Bolo Santosi", id = "civ_bolo_santosi_01" },
                -- { name = "Bouncer", id = "civ_bouncer_001" }, -- crashes
                { name = "Brrd Male", id = "civ_brrd_male_01" },
                { name = "Greenman Female", id = "civ_greenman_female_01" },
                { name = "Greenman Male", id = "civ_greenman_male_01" },
                { name = "Matsuda Male", id = "civ_matsuda_male_01" },
                { name = "Rome Male", id = "civ_rome_male_01" },
                { name = "Beachgoer Female", id = "civ_beachgoer_female_01" },
                { name = "Beachgoer Male", id = "civ_beachgoer_male_01" },
                { name = "Dockworker Female", id = "civ_dockworker_female_01" }, -- crashes
                { name = "Dockworker Male", id = "civ_dockworker_male_01" }, -- crashes
                -- { name = "Spear Fisherman", id = "civ_spear_fisherman_001" }, -- crashes
                { name = "Favela Female", id = "civ_favela_female_01" },
                { name = "Favela Male", id = "civ_favela_male_01" },
                { name = "Rainforest Female", id = "civ_rainforest_female_01" },
                { name = "Rainforest Male", id = "civ_rainforest_male_01" },
                { name = "Desert Female", id = "civ_desert_female_01" },
                { name = "Desert Male", id = "civ_desert_male_01" },
                { name = "Grasslands Female", id = "civ_grasslands_female_01" },
                { name = "Grasslands Male", id = "civ_grasslands_male_01" },
                { name = "Business Female", id = "civ_business_female_001" },
                { name = "Business Male", id = "civ_business_male_001" },
                { name = "Vagrant Female", id = "civ_vagrant_female_001" },
                { name = "Vagrant Male", id = "civ_vagrant_male_001" },
                { name = "Athletic Female", id = "civ_athletic_female_001" },
                { name = "Athletic Male", id = "civ_athletic_male_001" },
                { name = "Soccer Aa Female", id = "civ_soccer_aa_female_01" },
                { name = "Soccer Aa Male", id = "civ_soccer_aa_male_01" },
                { name = "Soccer Esp Female", id = "civ_soccer_esp_female_01" },
                { name = "Soccer Esp Male", id = "civ_soccer_esp_male_01" },
                { name = "Soccer Female", id = "civ_soccer_female_001" },
                { name = "Soccer Male", id = "civ_soccer_male_001" },
                { name = "Upperclass Female", id = "civ_upperclass_female_01" },
                { name = "Upperclass Male", id = "civ_upperclass_male_01" },
                { name = "Farmer Female", id = "civ_farmer_female_01" },
                { name = "Farmer Male", id = "civ_farmer_male_01" },
                { name = "Bartender Female", id = "civ_bartender_female_01" },
                { name = "Bartender Male", id = "civ_bartender_male_01" },
                { name = "Airport Worker Female", id = "civ_airport_worker_female_01" },
                { name = "Airport Worker Male", id = "civ_airport_worker_male_01" },
                { name = "Art Vendor Female", id = "civ_art_vendor_female_01" },
                { name = "Art Vendor Male", id = "civ_art_vendor_male_01" },
                { name = "Factory Worker Female", id = "civ_factory_worker_female_01" },
                { name = "Factory Worker Male", id = "civ_factory_worker_male_01" },
                { name = "Food Vendor Female", id = "civ_food_vendor_female_01" },
                { name = "Food Vendor Male", id = "civ_food_vendor_male_01" },
                { name = "Gas Station Female", id = "civ_gas_station_female_01" },
                { name = "Gas Station Male", id = "civ_gas_station_male_01" },
                { name = "Graffitiartist Female", id = "civ_graffitiartist_female_01" },
                { name = "Graffitiartist Male", id = "civ_graffitiartist_male_01" },
                { name = "Street Musician Female", id = "civ_street_musician_female_01" },
                { name = "Street Musician Male", id = "civ_street_musician_male_01" },
                { separator = true, name = "Animals" },
                -- { name = "Caracu Cow 1", id = "caracu_cow_01" }, -- crashes
                -- { name = "Caracu Cow 2", id = "caracu_cow_02" }, -- crashes
                -- { name = "Cow Base", id = "cow_base" }, -- crashes
                -- { name = "Holando Argentino Cow 1", id = "holando_argentino_cow_01" }, -- crashes
                -- { name = "Holando Argentino Cow 2", id = "holando_argentino_cow_02" }, -- crashes
                -- { name = "Indo Brazilian Cattle Bull", id = "indo_brazilian_cattle01_bull" }, -- crashes
                -- { name = "Indo Brazilian Cattle Cow", id = "indo_brazilian_cattle01_cow" }, -- crashes
                -- { name = "Power Cow", id = "power_cow" }, -- crashes
                { name = "Deer Buck", id = "deer_buck" },
                { name = "Deer Doe", id = "deer_doe" },
                { name = "Dog", id = "dog" },
                -- { name = "Bhuj Goat", id = "bhuj_goat" }, -- crashes
                -- { name = "Goat Generic", id = "goat_generic" }, -- crashes
                -- { name = "Repartida Goat", id = "repartida_goat" }, -- crashes
                { name = "Tapir", id = "tapir" },
                { name = "Llama", id = "llama" },
                { name = "Llama 2", id = "llama_02" },
                { name = "Llama 3 Sheared", id = "llama_03_sheared" },
                { name = "Capybara", id = "capybara" },
                { name = "Domestic Pig", id = "domestic_pig" },
                { name = "Feral Hog", id = "feral_hog" },
                { name = "Wild Boar", id = "wild_boar" },
